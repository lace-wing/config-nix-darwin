...
// darker earthy green
// const vec4 TRAIL_COLOR = vec4(0.302, 0.302, 0.216, 1.);
// const vec4 TRAIL_COLOR_ACCENT = vec4(0.502, 0.502, 0.416, 1.);
// const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
// const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
// const float DURATION = 0.25;
// light pink
const vec4 TRAIL_COLOR = vec4(0.89, 0.73, 0.94, 1.);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.89, 0.73, 0.94, 1.0);
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const float DURATION = 0.25;
